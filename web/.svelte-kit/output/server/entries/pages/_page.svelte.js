...
function _page($$payload, $$props) {
  push();
  let primaryBg, secondaryBg, tertiaryBg, quaternaryBg, primaryText, secondaryText, buttonHoverBg, buttonHoverText, buttonBorder;
  primaryBg = "bg-black";
  secondaryBg = "bg-neutral-950";
  tertiaryBg = "bg-black";
  quaternaryBg = "bg-zinc-950";
